...
export default function HomepageProjects() {
    ...
    return (
        <section className="py-20 md:py-32 relative overflow-hidden" id="Projects">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] md:w-[700px] md:h-[700px] bg-gradient-to-tr from-violet-600/5 to-indigo-600/5 dark:from-violet-500/10 dark:to-indigo-500/10 rounded-full blur-[100px] md:blur-[150px] pointer-events-none z-0" />

            <div className="container relative z-10 max-w-[1240px] mx-auto px-4">
                {/* Section Header */}
                <div className="text-center max-w-[700px] mx-auto mb-16 md:mb-24">
                    ...
                    <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight mb-4 text-slate-900 dark:text-white leading-tight">
                        Featured Projects
                    </h2>
                    <p className="text-sm md:text-base text-slate-500 dark:text-slate-400 font-medium">
                        A selected collection of software architectures, smart assistants, and decentralized solutions built with cutting-edge tools.
                    </p>
                </div>
                    ...
                    {featuredProjects.map((project) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col flex-1 p-6 md:p-8">
                                <div className="mb-4">
                                    <h3 className="text-xl md:text-2xl font-bold text-slate-900 dark:text-white group-hover:text-violet-600 dark:group-hover:text-violet-400 transition-colors duration-300">
                                        {project.title}
                                    </h3>
                ...
                <div className="mt-16 md:mt-24 text-center">
                    <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-slate-50/50 dark:bg-slate-900/30 border border-black/5 dark:border-white/5 px-6 md:px-8 py-5 rounded-3xl backdrop-blur-md">
                        <span className="text-xs md:text-sm text-slate-500 dark:text-slate-400 font-medium">
                            Want to see more? Explore all of my projects and creations.
                        </span>
                        <Link
                            href="/projects"
                            className="group inline-flex items-center gap-2 bg-slate-950 hover:bg-slate-900 dark:bg-white dark:hover:bg-slate-100 text-white dark:text-slate-950 text-xs md:text-sm font-bold px-6 py-2.5 rounded-full transition-all duration-300 hover:scale-102"
                        >
                            See All Projects
